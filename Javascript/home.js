...
//                                     <p class="card-text text-center">${item.price} <span> ₼</span></p>
//                                     <a href="#" id="addnew" onclick = "cntcart(${item.id})" class="btn btn-primary float-end">                        
...
// getData();
// function cntcart(id) {
//     let basketproduct = data.find(item => {
//         return id === item.id
//     });
//     if (basketArr.includes(basketproduct)) {
//         alert('Product artiq sabete elave olunub')
//         return 0;
//     }
//     else {
    ...
    row.innerHTML += `<div class="col-md-3">
                            <div class="card my-3">
                              ...
                              <div class="card-body">
                                <h6 class="card-title text-center">${item.title}</h6>
                                <p class="card-text text-center">${item.price} <span> ₼</span></p>
                                <a href="#" class="btn btn-primary float-end" onclick="addToBasket(${item.id})">
...
function addToBasket(id) {
  let basketproduct = data.find(item => item.id === id);
  if (!basketArr.some(product => product.id === id)) {
    basketArr.push(basketproduct);
    localStorage.setItem('basketArr', JSON.stringify(basketArr));
  } else {
    alert('Product already added to basket');
  }
}
getData();
...
// console.log('Body width:', document.body.clientWidthg, 'px');